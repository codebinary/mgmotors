  ...
  $('#departamento').on('change', function() {
    ...
    $('#departamento option:selected').each(function() {
      ...
      if(departamento != ''){
        ...
        $.post(BASE_URL + 'modulos/webservice/modulos/obtenerProvincia.php', {departamento: departamento}, function(data) {
  ...
  $('#provincia').on('change', function() {
    ...
    $('#provincia option:selected').each(function() {
      ...
      if(provincia != ''){
        ...
        $.post(BASE_URL + 'modulos/webservice/modulos/obtenerDistritos.php', {provincia: provincia, departamento:departamento}, function(data) {
...
*/
    ...
    submitHandler: function() {
      ...
      $.ajax({
        ...
        url: BASE_URL + "modulos/webservice/modulos/insertarCotizacion.php",
        ...
        success: function(data) {
          ...
          window.location.href = BASE_URL +  "contactenos-enviado-test.php?cod="+data;
