...
if ($_SESSION['estado'] == "activo" and $_POST['origen']=='formulario'){//Si es correcto, procede al envio de datos y guardado en la base de datos
	...
	/*mysql_query("INSERT INTO cotizacion (nombres,apellidos,telefono,email,dni,modelo,color,tienda,comentarios, plazos, inicial, doblecuota,fecha) 
