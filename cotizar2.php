        ...
        <div class="col-lg-10 col-sm-10 col-sx-10 fix-padding">
          ...
          <div id="cotizar-content">
            ...
            <div id="form-cotizar-mg">
              <form role="form" id="formulario-cotizar" method="post" action="cotizar-datos2.php">
            ...
            <div id="form-financia">
              <div class="cuotas-data">
                ...
                <div class="cuota-item">
                  ...
                  <ul>
                    <li>
                      <input type="radio" name="inicial" id="radio_01_02" value="20%" class="primero" checked="checked">
