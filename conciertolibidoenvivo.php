          ...
          <div class="col-lg-12 col-sm-12 col-sx-12 cotizar">
            <div class="col-lg-1 col-sm-1 col-sx-1"></div>
              <div class="col-lg-10 col-sm-10 col-sx-10 fix-padding">
                ...
                <div id="titulo"><h1>EVENTO <span>]</span></h1><div id="linea-titulo-promociones"></div></div>

                <div id="evento">
                  <div id="titulo-promo"></div><!-- end of titulo-promo -->
                  
                  <script type="text/javascript" src="http://www.streamperu.com/Server/player/jwplayer.js"></script>
                  <div class="video" id="streamperu"></div><!-- video -->
                  <script type="text/javascript" src="http://www.streamperu.com/Server/mgperu/live.js"></script>
                </div><!-- end of promo -->
