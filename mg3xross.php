        ...
        <div class="container fix-padding">
            ...
            <div class="container">
                ...
                <div class="col-lg-7 fix-padding">
                    <div id="form-cotizar">
                        <form role="form" id="cotizar-mg3xross" method="post" action="cotizar-datos.php">
                            ...
                            <div>
                            <select class="mg3xross-input" name="modelo" id="modelo">
                            ...
                            <div>
                            <select class="mg3xross-input" name="color" id="color">
                            ...
                            <div>
                            <select class="mg3xross-input" name="tienda" id="tienda">
                            ...
                            <div>
                            <input type="image" src="images/modelos/mg3xross/enviar-btn.png" id="btnSubmit" name="btnSubmit"/>
