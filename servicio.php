      ...
      <div class="col-lg-12 col-sm-12 col-sx-12 cotizar">
        ...
        <div class="col-lg-10 col-sm-10 col-sx-10 fix-padding">
          ...
          <nav class="menu-postventa">
            <ul>
              <li class="activado"><a href="servicio.php">SERVICIO</a><div><img class="centrar" src="images/historia/arrow-menu.png" /></div></li>
              <li class="linea">|</li>
          ...
          <div id="mantenimiento-content">            
            <div id="form-mantenimiento-mg">
            <h2>agenda tu servicio</h2>
              <form role="form" id="formulario-mantenimiento" method="post" action="servicio-datos.php">
                ...
                <div>
                  <select class="mantenimiento-input" name="modelo" id="modelo">
                ...
                <div>
                  <select class="mantenimiento-input" name="modelo" id="modelo">
                    <option value="">- Elije el tipo de revisión -</option>
                ...
                <div class="fecha-bloque">
                  <input class="placa clear-fix" type="text" name="placa" id="placa" placeholder="Ingresa tu Nº de placa">
                </div>
                  <div>
                  ...
                  <div>
                    <select class="mantenimiento-input" name="taller" id="taller">
                      <option value="">- Elige un Taller Autorizado-</option>
                    </select>
                  </div>
                <!-- Elije un día -->
                <div class="dia-bloque">
                  <input class="fecha" type="text" name="dia" id="dia" placeholder="Elije un día">
                </div>
                <div class="hora-bloque">
                  <input class="hora" type="text" id="hora" name="hora" placeholder="Ingresa la hora">
                </div>
                <div class="clear-fix">

                </div>
                <!-- Elije un día -->
                <div class="comentarios clear-fix">
            ...
            <div id="imagen-mantenimiento">
              <p>*Para reservas de cita menores a las 24 horas, deberá comunicarse directamente con la Central de Citas del concesionario de su preferencia.<br>
              *La cita solicitada es solo una reserva previa, se considerara valida una vez que el asesor se comunique con usted.<br>
              *Horarios sujetos a variación.</p>
            </div>
