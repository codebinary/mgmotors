...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <?php include "modulos/common/menu.php" ?>
          ...
          <div id="bannerhome-content">
                  ...
                  <div id="bannerhome">
                      <a href="mg3.php"><img src="images/bannerhome/slide/mg3.jpg" /></a>
                      <a href="mg5.php"><img src="images/bannerhome/slide/mg5.jpg" /></a>
                      <!--<a href="promociones.php"><img src="images/bannerhome/slide/killerweek.jpg" /></a>-->
                      <a href="mg350.php"><img src="images/bannerhome/slide/mg350.jpg" /></a>
                      <a href="mg3xross.php"><img src="images/bannerhome/slide/mg3xross.jpg" /></a>
                ...
                <ul>
                  ...
                  <li><a href="https://www.pinterest.com/mgperu/" target="_blank"><img src="images/bannerpromocion/pt.png" /></a></li>
                </ul>
                </div>
                <div id="promocion-banner">
                  <a href="http://www.mgmotors.com.pe/financiamiento.php"><img src="images/bannerpromocion/santander-btn-home.png" /></a>
                </div>
          </div>
        ...
        <div class="botones-home">
          ...
          <?php include "modulos/banners-inferiores.php" ?>
            ...
            <!-- <div id="hidden_link">
              ...
              <div style="width:640px;" height:"560px;">
                <a href="#"><img id="popup" src="images/pop_up/pop_image.jpg"></a>
              </div>
        ...
        $(document).ready(function(){
          $("#popup").on('click',function(){
              location.href="http://mgmotors.com.pe/promociones.php";
          })
        })
        $(document).ready(function(){
