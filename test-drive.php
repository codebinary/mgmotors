...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <!--Menu principal-->
        ...
        <div class="col-lg-10 col-sm-10 col-sx-10 fix-padding">
            <div id="titulo"><h1>TEST-DRIVE<span>]</span></h1><div id="linea-titulo-cotizar"></div></div>

                <!-- Manteimiento-Content -->
                <div id="testdrive-content">

                  <div id="imagen-test-drive">
                    
                  </div>

                    <h2>solicita tu test-drive</h2>
                    <div id="form-mantenimiento-mg">
                        <form role="form" id="formulario-mantenimiento" method="post" action="testdrive-datos.php">
                            ...
                            <div class="fecha-bloque">
                            <input class="fecha" type="text" id="hora" name="hora" placeholder="Ingresa al ahora">
                            </div>
        ...
        <script defer src="js/validacion_testdrive.js"></script>
