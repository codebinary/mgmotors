...
<!-- Facebook Conversion Code for Nueva Web - Cotización MG3 -->
<script type="text/javascript">
var fb_param = {};
fb_param.pixel_id = '6013199518623';
fb_param.value = '0.00';
...
<noscript><img height="1" width="1" alt="" style="display:none" src="https://www.facebook.com/offsite_event.php?id=6013199518623&amp;value=0&amp;currency=USD" /></noscript>
    ...
    <!--Menu principal-->
        ...
        <div class="col-lg-10 fix-padding">
            <div id="titulo"><h1>POST-VENTA  <span>]</span></h1><div id="linea-titulo-cotizar"></div></div>

                <!-- Enviado -->
                <div id="enviado-content">
...
<!-- Pixel MG3 -->
<iframe src="http://www2.balao.de/SLIH1" scrolling="no" frameborder="0" width="1" height="1"></iframe>
<!--// Pixel MG3-->
