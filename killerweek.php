              ...
              <div class="col-lg-10 col-sm-10 col-sx-10 fix-padding">
                ...
                <div id="promo">
                  ...
                  <div id="mantenimineto">
                      <img src="images/lucetecontumg/mantenimiento.jpg" alt="mantenimiento">
                  </div><!-- mantenimineto-->
                  <div id="celeration">
                      <img src="images/lucetecontumg/celeration.png" alt="celeration">
                  </div><!-- celeration-->
                  <ul id="redes">
                  ...
                  <div id="terminos">
                      <a href="http://www.mgmotors.com.pe/promociones.php" target="_blank"><img src="images/lucetecontumg/terminos.jpg" alt=""></a>
                  </div>
                </div><!-- end of promo -->
