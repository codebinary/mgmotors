...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <style>
            .mg5 form#formulario-cotizar input[type="text"]{font-family: Arial, sans-serif;
                font-size: 12px;
                color: #2c2c2c;
                background: #A62D94;
            ...
            .mg5 form#formulario-cotizar select{font-family: Arial, sans-serif;
                font-size: 12px;
                color: #2c2c2c;
                background: #A62D94;
                border: #eeeeee solid 1px;
            ...
            .mg5 form#formulario-cotizar textarea{font-family: Arial, sans-serif;
        ...
        <div class="container fix-padding">
            <div class="row">
                <div class="col-lg-12 mg5-landing">
                    ...
                    <div id="enlace-turbo-mobile">CONOCE LA VERSIÓN <a href="mg5-turbo.php"><span>TURBO</span></a></div>
                        <div id="descripcion">
